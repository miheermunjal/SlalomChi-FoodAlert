...
declare -r JOB_ID="slalom_employees_facial_recognition_9"
declare -r BUCKET="gs://slalom_employees_facial_recognition-ml"
declare -r GCS_PATH="${BUCKET}/${USER}/${JOB_ID}"
declare -r DICT_FILE=gs://slalom-employees-facial-recognition/img/dict.txt

declare -r MODEL_NAME=slalom_employees
...
#  --input_path "gs://slalom-employees-facial-recognition/img/eval_set.csv" \
#  --output_path "${GCS_PATH}/preproc/eval" \
#  --cloud
#
#python trainer/preprocess.py \
#  --input_dict "$DICT_FILE" \
#  --input_path "gs://slalom-employees-facial-recognition/img/train_set.csv" \
